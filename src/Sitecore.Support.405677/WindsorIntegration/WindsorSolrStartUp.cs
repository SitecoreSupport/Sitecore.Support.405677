namespace Sitecore.Support.ContentSearch.SolrProvider.WindsorIntegration
{
  ...
  public class WindsorSolrStartUp : ISolrStartUp
  {
    ...
    public void Initialize()
    {
      ...
      this.Container.Register(new IRegistration[] { Component.For<ISolrSchemaParser>().ImplementedBy<Sitecore.ContentSearch.SolrProvider.Parsers.SolrSchemaParser>().OverridesExistingRegistration<ISolrSchemaParser>() });
      if (SolrContentSearchManager.EnableHttpCache)
      {
        ConfigureHttpCache();
      }
